...
@string.43 = private unnamed_addr constant [54 x i8] c"User agent is IE browser whether the version is 8.0: \00"
@string.44 = private unnamed_addr constant [2 x i8] c"r\00"
@string.45 = private unnamed_addr constant [20 x i8] c"pb_access_log.nginx\00"
@string.46 = private unnamed_addr constant [18 x i8] c"/pv.gif/&/cl.gif/\00"
...
entry:
  %a = alloca i8*
  %i = alloca i32
  %puts = call i8* (i8*, ...) @puts(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @string.43, i32 0, i32 0))
  %fopen = call i8* @fopen(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @string.45, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @string.44, i32 0, i32 0))
  store i8* %fopen, i8** %a
  %a1 = load i8*, i8** %a
  %tape_result = call i32 @tape(i8* %a1, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @string.46, i32 0, i32 0))
  ret i32 0
}
