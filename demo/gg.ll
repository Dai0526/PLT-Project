...
@string.45 = private unnamed_addr constant [17 x i8] c"Search between :\00"
...
entry:
  ...
  store i8* %fopen, i8** %a
  %puts = call i8* (i8*, ...) @puts(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @string.45, i32 0, i32 0))
  %a1 = load i8*, i8** %a
